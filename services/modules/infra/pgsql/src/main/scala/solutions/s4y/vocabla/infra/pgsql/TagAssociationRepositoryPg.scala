...
class TagAssociationRepositoryPg extends TagAssociationRepository[Entry]:
  ...
  override def getTagged(
      tagId: Identifier[Tag]
  ): ZIO[TransactionContext, String, Chunk[Identifier[Entry]]] =
    pgSelectMany(
...
object TagAssociationRepositoryPg:
  ...
  val layer: ZLayer[DataSourcePg, String, TagAssociationRepository[Entry]] =
    ZLayer {
      ZIO
